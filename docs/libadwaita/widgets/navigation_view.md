...
Short summary: Single-window navigation container for stack-based navigation. Useful for apps that present a single primary view at a time with hierarchical navigation.
